...
///回调一个参数
typedef EditorSizeCallback<D> = dynamic Function(D data);
class RawEditorState extends EditorState
  ...
  final Map<String,EditorSizeCallback<Size?>> editorSizeCallbackMap = {};
  ...
  void didUpdateWidget(RawEditor oldWidget) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      for(var key in editorSizeCallbackMap.keys){
        editorSizeCallbackMap[key]?.call(_editorKey.currentContext!.size);
      }
  ...
  void addRawEditorSizeCallback(String key,EditorSizeCallback<Size?> callback){
    editorSizeCallbackMap[key] = callback;
  }
