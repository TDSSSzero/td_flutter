...
class MindsetAutoText extends StatefulWidget {
  /// Creates a [AutoSizeText] widget.
  ///
  /// If the [style] argument is null, the text will use the style from the
  /// closest enclosing [DefaultTextStyle].
  const MindsetAutoText(
      String this.data, {
        Key? key,
        this.textKey,
        this.style,
  ...
  @override
  State<MindsetAutoText> createState() => _MindsetAutoTextState();
}

class _MindsetAutoTextState extends State<MindsetAutoText> {
  ...
  @override
  void didUpdateWidget(MindsetAutoText oldWidget) {
  ...
  bool _checkTextFits(TextSpan text, double scale, int? maxLines, BoxConstraints constraints) {
    ...
    // print("auto height ${textPainter.height},width ${textPainter.width}");
