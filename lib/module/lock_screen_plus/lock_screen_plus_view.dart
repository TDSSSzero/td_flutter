...
import 'lock_screen_plus_logic.dart';


class LockScreenPlusPage extends StatefulWidget {
  LockScreenPlusPage({Key? key}) : super(key: key);

  @override
  State<LockScreenPlusPage> createState() => _LockScreenPlusPageState();
}

class _LockScreenPlusPageState extends State<LockScreenPlusPage> {
  final logic = Get.put(LockScreenPlusLogic());

  final state = Get.find<LockScreenPlusLogic>().state;
